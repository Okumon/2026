...
local Star = nill:Window("หี ควย แตด")

local StarServer = Star:Server("นักสี้ X HUB",8521503225)
...
local drop = Main:Dropdown("Select Player ", Playerslist, function(t)
    PlayerTP = t
...
Main:Button("Refresh Dropdown", {"Refresh Dropdown"}, function()
    ...
    print("========== REFRESH ==========")
    print("Players Count =", #Playerslist)
    ...
    print("drop =", drop)
    print("drop.Refresh =", drop.Refresh)
...
Main:Label("Tween Mode")

Main:Toggle("Tween to Player", _G.Teleport_to_Player, function(value)
